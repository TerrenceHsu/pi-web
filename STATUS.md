...
| **Current phase** | **P2-R2 PDF → Canonical Markdown Pipeline ✅ COMPLETE / FROZEN** — 全链 R2-A / R2-B / R2-C / R2-D-A / R2-D-Fix / R2-D-B ✅ COMPLETE；historical 8-test discrepancy ✅ RECONCILED；R1 targeted count ✅ RECONCILED（118 selected = 117 passed + 1 skipped）；C4-R archived Ruff claim correction @ `a27494c`。下一阶段 P2-R3 Heading-aware Chunk + SQLite FTS5 ✅ APPROVED TO START（不在本提交启动）。详见 [P2_R2_D_FINAL_PDF_PIPELINE_VALIDATION.md](docs/validation/p2-r2/P2_R2_D_FINAL_PDF_PIPELINE_VALIDATION.md)。 |
