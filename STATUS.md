...
| **Current phase** | P2-R2-B Canonical Markdown Builder — ✅ COMPLETE @ `eb193b2`（含 P2-R0 Amendment 2 `15b411b` + R2-B1 quality `0154cde` + R2-B2 markdown `c077d5a` + R2-B3 persistence `677ed13` + R2-B4 freeze `eb193b2`；3 new modules + 160 targeted tests + 0 functional regression；frontmatter schema + needs_ocr 阈值按 amendment-2 精化）；**P2-R2-B Contract/Archive Closure 🟡 REQUIRED**（Amendment 2 authorization audit 完成待用户追认，详见 [P2_R2_B_AMENDMENT2_AUTHORIZATION_AUDIT.md](docs/validation/p2-r2/P2_R2_B_AMENDMENT2_AUTHORIZATION_AUDIT.md)）；下一阶段 P2-R2-C ⛔ BLOCKED BY R2-B ARCHIVE CLOSURE |
| **R2-B Archive Closure** | Audit doc 已提交（docs-only）；用户在 §7.2 选择 A/B/C 后：A → R2-B 升级 FROZEN + R2-C 门开；B → 继续阻塞；C → 部分回滚。G1 stash `d7240268` 跨 R2-B 全程未变。详见 [P2_R2_B_AMENDMENT2_AUTHORIZATION_AUDIT.md §7](docs/validation/p2-r2/P2_R2_B_AMENDMENT2_AUTHORIZATION_AUDIT.md) |
