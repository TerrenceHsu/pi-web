...
| **Current phase** | **P2-R3 Heading-aware Chunk + SQLite FTS5 🟡 IN PROGRESS** — R3-A ✅ FROZEN @ `677fe33` + R3-A-R ✅ FROZEN @ `64b7416` + R3-B1 Schema Migration v1→v2 ✅ FROZEN @ `f3401ab` + R3-B2 Chunk/FTS Store ✅ FROZEN @ `db03be7` + **R3-B3 Validation Freeze ✅ COMPLETE / FROZEN**（docs-only；84/84 R3-B targeted tests；full Backend 3241/3/14/0 failed；R2 frozen 模块未触动；73/73 exit gate）。**P2-R3-B Schema + SQLite FTS5 ✅ COMPLETE / FROZEN**。R3-C Indexing Runtime ⛔ APPROVED TO START（独立授权另需）。详见 [P2_R3_B_SCHEMA_FTS5_VALIDATION.md](docs/validation/p2-r3/P2_R3_B_SCHEMA_FTS5_VALIDATION.md)。 |
