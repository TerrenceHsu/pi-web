...
| #  | 阶段                        | 目标                                                  | 状态 | GUIDE                                                                        |
| ---- | ----------------------------- | ------------------------------------------------------- | ------ | ------------------------------------------------------------------------------ |
| 1  | 最小可运行 Loop             | 项目骨架、Message、ModelClient、最小 Loop             | ✅   | [step-01-min-loop](steps/step-01-min-loop/GUIDE.md)                          |
| 2  | Event Stream                | Agent 事件流（emit/subscribe/10 种事件）              | ✅   | [step-02-event-stream](steps/step-02-event-stream/Architecture.md)           |
| 3  | Context 转换                | `transform_context` / `convert_to_llm`                | ✅   | [step-03-context-transform](steps/step-03-context-transform/Architecture.md) |
| 4  | Tool 基础模型               | ToolCall / ToolResult / AgentTool / ToolRegistry      | ✅   | [step-04-tool-model](steps/step-04-tool-model/Architecture.md)               |
| 5  | 单工具执行                  | 模型→工具→模型完整链路                              | ✅   | [step-05-single-tool](steps/step-05-single-tool/Architecture.md)             |
| 6  | Tool Hooks                  | before / after tool hook                              | ✅   | [step-06-tool-hooks](steps/step-06-tool-hooks/Architecture.md)               |
| 7  | 多工具执行                  | sequential / parallel / terminate                     | ✅   | [step-07-multi-tool](steps/step-07-multi-tool/GUIDE.md)                      |
| 8  | Agent 状态机                | AgentState / prompt / continue / subscribe            | ✅   | [step-08-agent-state](steps/step-08-agent-state/GUIDE.md)                    |
| 9  | Queue / Abort               | steer / follow_up / abort / wait_for_idle             | ✅   | [step-09-queue-abort](steps/step-09-queue-abort/GUIDE.md)                    |
| 10 | Harness Phase               | Harness 运行阶段控制                                  | ✅   | [step-10-harness-phase](steps/step-10-harness-phase/GUIDE.md)                |
| 11 | Turn Snapshot               | 每轮不可变快照 + active tools                         | ✅   | [step-11-turn-snapshot](steps/step-11-turn-snapshot/Architecture.md)         |
| 12 | Session Memory              | session tree / JSONL / fork / restore                 | ✅   | [step-12-session-memory](steps/step-12-session-memory/Architecture.md)       |
| 13 | Harness + Session           | pending writes / save point / 持久化                  | ✅   | [step-13-harness-session](steps/step-13-harness-session/Architecture.md)     |
| 14 | Skills / Templates          | SKILL.md / system prompt skill list / prompt template | ✅   | [step-14-skills-templates](steps/step-14-skills-templates/Architecture.md)   |
| 15 | Compaction / Branch Summary | 上下文压缩 + 分支摘要                                 | ✅   | [step-15-compaction-branch](steps/step-15-compaction-branch/Architecture.md) |
...
> 详见 [`WEB_CLAUDE_PLAN.md`](WEB_CLAUDE_PLAN.md) 与 [`TODO.md`](TODO.md)。
