...
> 当前代码位于 `0.0.29` 发布基线之后：三类意图路由与 Planner–Executor–Verifier Plan Mode 已完成；Session Workspace、自动 Memory、Managed Coding Sandbox、LLM Wiki、Provider Runtime、Approval、Context Budget/Compaction 等既有主线保持有效。
>
> 当前收敛重点是 Sandbox 冻结制品审阅、发布冲突恢复、空变更修复，以及 Chat/Workspace/Thinking 交互。实施事实和最新门禁数字见 [STATUS.md](STATUS.md)，后续优先级与明确延期项见 [ROADMAP.md](ROADMAP.md)。
