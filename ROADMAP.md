...
| **R3-C Indexing Runtime** | ⛔ APPROVED TO START（独立授权另需） | R3-B | IndexStore + IndexingOrchestrator（normalizing→chunking→indexing→ready T1/T2/T3 transactions）+ recovery + failure safe errors | 待 R3-C 启动 |
