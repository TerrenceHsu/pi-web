...
| **R3-C2 IndexingOrchestrator** | ⛔ APPROVED TO START（独立授权另需） | R3-C1 | Markdown read + integrity + Chunker/ChunkStore orchestration + ready gate + failure compensation | 待 R3-C2 启动 |
