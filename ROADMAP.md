...
| **R3-D Bounded Index Worker** | ⛔ APPROVED TO START（独立授权另需） | R3-C | IndexingWorkerManager + lifespan wiring + delete guards（chunking/indexing → 409）+ restart/shutdown | 待 R3-D 启动 |
