...
| **R3-B2 Chunk/FTS Store** | ⛔ APPROVED TO START（独立授权另需） | R3-B1 | chunk_store.py：replace_document_chunks / delete_document_chunks / rebuild_fts / verify_fts_integrity / search_chunks_fts / safe literal FTS query compiler / BM25 + heading weight / ready-only / library filter | 等 R3-B2 启动 |
