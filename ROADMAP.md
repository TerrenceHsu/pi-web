...
| **R4 Session-scoped search_knowledge + Citation** | ⛔ APPROVED TO START（独立授权另需） | R3 | search_knowledge Agent Tool + Session→Library allowlist + Page Marker Citation | 待 R4 启动 |
