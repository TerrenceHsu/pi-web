...
| **R2-C1 Store Extensions + Orchestrator** | ✅ APPROVED TO START（独立启动授权另需用户发起） | R2-C0 | KnowledgeStore 新方法 + FileStore 新方法 + IngestionOrchestrator + 单元测试 | claim atomic / 失败矩阵覆盖 / generated_at omitted |
