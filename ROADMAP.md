...
| **R4-C2 system prompt + Assistant finalize** | ⛔ APPROVED TO START（独立授权另需） | R4-C1 | system prompt knowledge citation rules + Assistant message finalize transform | 待 R4-C2 启动 |
