...
| **R4-B Session-scoped search_knowledge** | ⛔ APPROVED TO START（独立授权另需） | R4-A | SearchKnowledgeService + search_knowledge Tool + Evidence DTO + EvidenceRegistry + Tool registration | 待 R4-B 启动 |
